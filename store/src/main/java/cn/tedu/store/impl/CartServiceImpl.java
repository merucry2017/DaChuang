...
public class CartServiceImpl implements ICartService {
	...
	@Override
	public void reduceNum(Integer uid, String username, Integer cid)
			throws CartNotFoundException, AccessDeniedException, UpdateException {
		// 根据参数cid查询数据：findByCid(cid)
		Cart result = findByCid(cid);
		// 判断查询结果是否为null
	...
	@Override
	public List<CartVO> getByBid(Integer bid) {
	...
	private List<CartVO> findByBid(Integer bid) {
		return cartMapper.findByBid(bid);
	}
	 ...
	 */
	@Override
	public List<CartVO> getPageByUid(Integer uid, Integer page) {
		// TODO Auto-generated method stub
		int index = (page-1)*3;
		List<CartVO> carts = cartMapper.findPageByUid(uid,index,3);
		return carts;
	}

	
	@Override
	public Integer getPageCount(Integer uid) {
		// TODO Auto-generated method stub
		Integer count = cartMapper.findPageCount(uid);
		return count;
	}
	@Override
	public List<CartVO> getallByUid(Integer uid) {
		// TODO Auto-generated method stub
		List<CartVO> carts = cartMapper.getallByUid(uid);
		return carts;
	}
}